...
print (f"Total of all loans = {total_of_loans}")

# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount
# YOUR CODE HERE!
avg_of_loans=total_of_loans/number_of_loans
print (f"Average of all loans ={avg_of_loans}")
...
# YOUR CODE HERE!
discount_rate=0.2
present_value=future_value / pow((1+ discount_rate/12),remaining_months)
